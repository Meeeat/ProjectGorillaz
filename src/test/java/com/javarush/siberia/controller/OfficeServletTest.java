...
class OfficeServletTest {
    ...
    void doPost_AddStep() throws ServletException, IOException {
        ...
        when(request.getParameter("option_1")).thenReturn("Go");
        when(request.getParameter("next_1")).thenReturn("nextS1");
        when(request.getParameter("option_2")).thenReturn("Stay");
        when(request.getParameter("next_2")).thenReturn("nextS2");
